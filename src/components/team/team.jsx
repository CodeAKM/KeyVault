        ...
        <>
            <section className='section' id='introSection'>
                <div className='contentSection'>
                    <div className="welcomeText">About Me</div>
                    <div class="fade_rule"></div> 
                    <div className="welcomeText">Get to Know the Mind Behind Key Vault: Your Trusted Partner in Crafting a Secure Password Manager! With Expertise and Dedication, I've Developed an Easy-to-Use Solution Ensuring Your Online Accounts Stay Safe and Secure, Making Digital Security a Breeze!</div>
                </div>
            </section>
            ...
            <section className='section' id='cardSection'>
                <div className="contentSection" id='cardHolder'>
                    <card className = 'nameCard' id = "amanCard">
                        ...
                        <div className="name">Ashmit Kumar</div>
